...
export const getMoreProductsAsync = createAsyncThunk(
  ...
  async () =>{ // 두번째 인자값 : 액션이 발생했을 때 실행할 바동기 작업(주로 api요청)
  ...
  //세번째 인자값 : 추가 옵션(비동기 처리 전 취소, 비동기 실행 중 취소 동의 옵션)
);
...
const productSlice = createSlice({
  ...
  reducers: {
    ...
    // 상품 3개 추가가 되게끔
    //https://my-json-server.typicode.com/JEONwhail/db-shop/more-products 이거에 있는거 나오게
...
// export const addMoreProducts = (state) => state.product.addMoreProducts 잘못함
